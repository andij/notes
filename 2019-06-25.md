...
The benefit of implementing such a technique helps by limiting the choice to the designer - keeping things more consistent. Trusting the system to maintain the relationship of size between _things_ and knowing that we are producing a harmonic visual experience.
