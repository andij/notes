...
Let's start with 1.25, the Major third.
...
Taking 16px and doing the sums, multiplying each by 1.25
...
Then using these numbers, choose which to apply to the hierarchy of our typography.
...
Here are these headings; and our paragraphs displayed in our font.
...
So; that's a glimpse into how we are using modular scale to inform the sizes of things within our design system. We've applied them to Viewports and Typography.
...
Implementing such a technique limits choice to the designer, the benefit of which helps to keep things consistent. We can trust the system to maintain the relationship of size between _things_ and we are confident that we are producing a harmonic visual experience.
